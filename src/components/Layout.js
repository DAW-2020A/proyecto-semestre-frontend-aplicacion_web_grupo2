                    ...
                    <Col span={20}>
                        <Header className='header'>
                            <Row type='flex' justify='space-between' align='bottom'>
                                <h1 style={{color: "white"}}>Trial-Q</h1>
                                {
                                    isAuthenticated
                    ...
                    <Row>
                        ...
                        <Col xs={{
                            ...
                            <p><WhatsAppOutlined/> <a href='https://wa.me/593988185518' target='_blank'
                                                      rel='noopener noreferrer'>+593 9-8818-5518</a></p>
                            <p><GithubOutlined/> <a
                                href='https://github.com/DAW-2020A/proyecto-semestre-frontend-aplicacion_web_grupo2'
                                target='_blank'
